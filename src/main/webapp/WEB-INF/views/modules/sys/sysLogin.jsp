...
<head>
	...
	<style type="text/css">
		html,body,table{text-align:center;}.form-signin-heading{font-family:Helvetica, Georgia, Arial, sans-serif, 黑体;font-size:36px;margin-bottom:50px;color:#0663a2;}
      ...
      .header{height:60px;padding-top:0px;} .alert{position:relative;width:300px;margin:0 auto;*padding-bottom:0px;}
...
<div class="dgs11"  style=" height: 100%">
	<%--<img src="${ctxStatic}/aquote/images/bz.png" align="left">--%>
